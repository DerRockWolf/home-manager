...
let
  ...
  toThunderbirdAddressBook = addressbook:
    ...
    in {
      ...
      "ldap_2.server.addressbook_${id}.uid" =
        id; # TODO: check if this is required
      "ldap_2.server.addressbook_${id}.position" =
        0; # TODO: check if this is required
    ...
    # TODO: assert if remote.type is not carddav!
    // optionalAttrs
